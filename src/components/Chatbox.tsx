  ...
  return (
    <div className="h-screen flex-1 bg-[#0E0E0E] border-r border-r-[#1C1B1B]/70 flex flex-col">
      ...
      <div className="w-full h-25 p-5 flex items-center  gap-3 bg-[#0E0E0E]/10 backdrop-blur-xl">
        ...
        <div className="size-10 rounded-lg bg-[#B76DFF] flex justify-center items-center cursor-pointer hover:bg-[#c082ff] duration-200 transition-all"><MdSend size={20} color="#2C0051" /></div>
      </div>
    </div>
  );
};
